...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='Launch Site',
        title='Success chart per location')
        return fig
    else:
...
def scatter(entered_site,payload):
    ...
    if entered_site=='ALL':
        ...
        fig=px.scatter(filtered_df[filtered_df['Launch Site']==entered_site],x='Payload Mass (kg)',y='class',color='Booster Version Category',title=f"Payload mass")
        return fig
